...
class Employee:
    def __init__(self, name, age, doj, email, gender, contact, address):
        self.name = name
        self.age = age
        self.doj = doj
        self.email = email
...
class Database:
    ...
    def insert(self, name, age, doj, email, gender, contact, address):
        employee = Employee(name, age, doj, email, gender, contact, address)
    ...
    def fetch(self):
        ...
        for i, employee in enumerate(self.employees, start=1):
            data.append((i, employee.name, employee.age, employee.doj, employee.email, employee.gender,
                         employee.contact, employee.address))
        return data

    def update(self, index, name, age, doj, email, gender, contact, address):
        employee = self.employees[index - 1]
        employee.name = name
        employee.age = age
        employee.doj = doj
...
def display_all():
    ...
    for i, row in enumerate(db.fetch(), start=1):
        tv.insert("", END, values=(i,) + row[1:])
